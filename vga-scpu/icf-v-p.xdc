...
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { AUD_SD }]; #IO_L6P_T0_15 Sch=aud_s
...
create_generated_clock -name Clk_CPU -source [get_ports clk] \
      -divide_by 16 \
      [get_pins clk_div/u_bufg_cpu/O]