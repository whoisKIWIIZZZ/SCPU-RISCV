...
initial begin
    wait(rstn == 1);   
         // 等复位结束
         force uut.U9_Counter_x.counter0_Lock = 32'h000F;
          force uut.U9_Counter_x.counter_ch            = 2'b0;         // 触发加载初值
        force uut.U9_Counter_x.counter_Ctrl  = 24'b0;   // 模式00
        force uut.U9_Counter_x.M0            = 1'b1;     // 触发装载！
        #10;
        release uut.U9_Counter_x.counter0_Lock;
        release uut.U9_Counter_x.counter_Ctrl;
